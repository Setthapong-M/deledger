...
The detailed transaction contract lives in [database standards](../standards/backend/database.md). GET requests may trigger catch-up; do not assume reads always leave calendar state untouched.
