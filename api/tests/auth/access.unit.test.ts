...
import { verifyAccessJwt, resetAccessJwksCache } from "../../src/server/auth/access-jwt.js";
...
describe("Cloudflare Access JWT boundary", () => {
  ...
  it("validates production and loopback configuration without exposing values", () => {
    expect(loadConfig({
      ...
      DATABASE_URL: "postgresql://deledger_web:secret@example:5432/deledger",
      IDENTITY_DATABASE_URL: "postgresql://deledger_identity:secret@example:5432/deledger",
