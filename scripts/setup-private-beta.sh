...
stage "Docker: external secrets and stack"
say "Compose keeps database role passwords in Docker secrets and gives the Tunnel token only to cloudflared."
step "Create external secrets named postgres_password, web_password, maintenance_password, and operator_password."
...
step "Enable deledger-backup.timer and run deledger-backup.service once."
